function [RawData,TE1times,ExpTime,AcqTime] = LoadKeaDET2data_new2(path_curr,exptnum)
...
maxWait=read_kea_acqu(path_curr,exptnum,'maxWait');
numTE1=read_kea_acqu(path_curr,exptnum,'nrWait');
if strcmpi(logyesno,'no') % Linear
    TE1times=linspace(minWait,maxWait,numTE1)';
else % log
    TE1times=logspace(log10(minWait),log10(maxWait),numTE1)';
end
