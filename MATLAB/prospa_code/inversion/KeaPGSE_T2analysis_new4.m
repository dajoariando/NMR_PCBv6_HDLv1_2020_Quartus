...
function KeaPGSE_T2analysis_new4(path_curr,expnum,Temp)
%% define parameters
...
% read kea data
[RawData,currValues,ldelta,bDelta,ExpTime,AcqTime] = LoadKeaPGSE_T2data_new2(path_curr,expnum); %loads the raw data
