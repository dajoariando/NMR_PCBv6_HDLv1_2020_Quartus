...
create_clock -name adc_clkout -period 40.000 -waveform {0 20} [get_ports {GPIO_1[21]}]
set_output_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[25]}]
set_output_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[25]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[20]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[20]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[21]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[21]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[22]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[22]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[23]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[23]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[24]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[24]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[25]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[25]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[26]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[26]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[27]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[27]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[28]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[28]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[29]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[29]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[30]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[30]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[31]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[31]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[32]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[32]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[33]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[33]}]
set_input_delay -clock { adc_clkout } -min 0 [get_ports {GPIO_1[34]}]
set_input_delay -clock { adc_clkout } -max 0 [get_ports {GPIO_1[34]}]
