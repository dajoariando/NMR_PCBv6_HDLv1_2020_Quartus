	soc_system_v5 u0 (
		...
		.dac_grad_MISO                             (<connected-to-dac_grad_MISO>),                             //                    dac_grad.MISO
		.dac_grad_MOSI                             (<connected-to-dac_grad_MOSI>),                             //                            .MOSI
		.dac_grad_SCLK                             (<connected-to-dac_grad_SCLK>),                             //                            .SCLK
		.dac_grad_SS_n                             (<connected-to-dac_grad_SS_n>),                             //                            .SS_n
		...
		.spi_afe_relays_MISO                       (<connected-to-spi_afe_relays_MISO>),                       //              spi_afe_relays.MISO
		.spi_afe_relays_MOSI                       (<connected-to-spi_afe_relays_MOSI>),                       //                            .MOSI
		.spi_afe_relays_SCLK                       (<connected-to-spi_afe_relays_SCLK>),                       //                            .SCLK
		.spi_afe_relays_SS_n                       (<connected-to-spi_afe_relays_SS_n>)                        //                            .SS_n
	);
