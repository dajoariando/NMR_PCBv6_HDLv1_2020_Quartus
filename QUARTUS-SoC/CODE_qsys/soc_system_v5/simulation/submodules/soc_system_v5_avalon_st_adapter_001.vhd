-- soc_system_v5_avalon_st_adapter_001.vhd
...
entity soc_system_v5_avalon_st_adapter_001 is
	generic (
		inBitsPerSymbol : integer := 32;
...
end entity soc_system_v5_avalon_st_adapter_001;

architecture rtl of soc_system_v5_avalon_st_adapter_001 is
	component soc_system_v5_avalon_st_adapter_001_timing_adapter_0 is
		port (
	...
	end component soc_system_v5_avalon_st_adapter_001_timing_adapter_0;

	signal in_rst_0_reset_ports_inv : std_logic; -- in_rst_0_reset:inv -> timing_adapter_0:reset_n

begin

	inbitspersymbol_check : if inBitsPerSymbol /= 32 generate
	...
	timing_adapter_0 : component soc_system_v5_avalon_st_adapter_001_timing_adapter_0
		port map (
...
end architecture rtl; -- of soc_system_v5_avalon_st_adapter_001
