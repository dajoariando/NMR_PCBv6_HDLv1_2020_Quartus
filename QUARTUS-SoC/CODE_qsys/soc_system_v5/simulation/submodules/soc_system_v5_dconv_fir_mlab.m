...
%                        coef_matrix(1,:) corresponds to coefficient at time unit 1.
%                        coef_matrix(2,:) corresponds to coefficient at time unit 2.
%
%                        coef_matrix(n,:) corresponds to coefficient at time unit n.
...
function  output = soc_system_v5_dconv_fir_mlab(stimulation, bank, coef_matrix_in);
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  1;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
