// soc_system_v5_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module soc_system_v5_mm_interconnect_0 (
	...
	soc_system_v5_mm_interconnect_0_router router (
	...
	soc_system_v5_mm_interconnect_0_router_001 router_001 (
	...
	soc_system_v5_mm_interconnect_0_router_002 router_002 (
	...
	soc_system_v5_mm_interconnect_0_router_002 router_003 (
	...
	soc_system_v5_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                  //        clk.clk
		.reset              (alt_vip_vfr_vga_clock_master_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	soc_system_v5_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                  //       clk.clk
		.reset              (alt_vip_vfr_vga_clock_master_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_v5_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_v5_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_v5_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_v5_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_v5_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                  //       clk.clk
		.reset               (alt_vip_vfr_vga_clock_master_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_v5_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                  //       clk.clk
		.reset               (alt_vip_vfr_vga_clock_master_reset_reset_bridge_in_reset_reset), // clk_reset.reset
