...
#define SYSID_QSYS_TIMESTAMP 1557087133
...
/*
 * Macros for device 'dac_mtch_ntwrk', class 'altera_avalon_spi'
 * The macros are prefixed with 'DAC_MTCH_NTWRK_'.
 * The prefix is the slave descriptor.
 */
#define DAC_MTCH_NTWRK_COMPONENT_TYPE altera_avalon_spi
#define DAC_MTCH_NTWRK_COMPONENT_NAME dac_mtch_ntwrk
#define DAC_MTCH_NTWRK_BASE 0x360
#define DAC_MTCH_NTWRK_SPAN 32
#define DAC_MTCH_NTWRK_END 0x37f
#define DAC_MTCH_NTWRK_IRQ 3
#define DAC_MTCH_NTWRK_CLOCKMULT 1
#define DAC_MTCH_NTWRK_CLOCKPHASE 0
#define DAC_MTCH_NTWRK_CLOCKPOLARITY 0
#define DAC_MTCH_NTWRK_CLOCKUNITS "Hz"
#define DAC_MTCH_NTWRK_DATABITS 24
#define DAC_MTCH_NTWRK_DATAWIDTH 32
#define DAC_MTCH_NTWRK_DELAYMULT "1.0E-9"
#define DAC_MTCH_NTWRK_DELAYUNITS "ns"
#define DAC_MTCH_NTWRK_EXTRADELAY 0
#define DAC_MTCH_NTWRK_INSERT_SYNC 0
#define DAC_MTCH_NTWRK_ISMASTER 1
#define DAC_MTCH_NTWRK_LSBFIRST 0
#define DAC_MTCH_NTWRK_NUMSLAVES 1
#define DAC_MTCH_NTWRK_PREFIX "spi_"
#define DAC_MTCH_NTWRK_SYNC_REG_DEPTH 2
#define DAC_MTCH_NTWRK_TARGETCLOCK 128000
#define DAC_MTCH_NTWRK_TARGETSSDELAY "0.0"
