...
add wave -noupdate /NMR_Controller_tb/uut/ACQ_WND_ALWAYS_ON
...
add wave -noupdate /NMR_Controller_tb/uut/ADC_ACQ_WINGEN1/ACQ_EN
add wave -noupdate /NMR_Controller_tb/uut/ACQ_EN_ALWAYS_ON
...
WaveRestoreCursors {{Cursor 1} {78692880 ps} 0}
