...
% ================================================================================
% Generated on: 11/13/2018 16:12:15
...
for j = 1:sx
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_final_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['fir_final_model_output'];
    ...
    plot(1:decimation:decimation*length(out{1}),out{1}./1000);
end
