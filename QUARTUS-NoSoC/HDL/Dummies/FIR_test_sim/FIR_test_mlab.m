...
function  output = FIR_test_mlab(stimulation, bank);
 coef_matrix_in= [144,115,158,207,263,325,392,462,535,609,682,752,817,876,926,968,998,1016,1023,1016,998,968,926,876,817,752,682,609,535,462,392,325,263,207,158,115,144];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  1;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
